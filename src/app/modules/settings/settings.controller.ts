...
const getIsUnderMaintenance = catchAsync(async (req, res) => {
     const result = await settingsService.getIsUnderMaintenance();
     sendResponse(res, {
          success: true,
          statusCode: StatusCodes.OK,
          message: 'Is Under Maintenance fetched successfully',
          data: result,
     });
});
