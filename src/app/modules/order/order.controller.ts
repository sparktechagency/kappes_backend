...
const cancelOrder = catchAsync(async (req: Request, res: Response) => {
     const result = await OrderService.cancelOrder(req.params.id, req.user as IJwtPayload);
...
const getOrdersByShopId = catchAsync(async (req: Request, res: Response) => {
     const result = await OrderService.getOrdersByShopId(req.params.shopId, req.user as IJwtPayload, req.query);
...
const getAllRefundOrderRequests = catchAsync(async (req: Request, res: Response) => {
     ...
     const result = await OrderService.getAllRefundOrderRequests(req.query, req.user as IJwtPayload, shopId);
...
const refundOrder = catchAsync(async (req: Request, res: Response) => {
     const result = await OrderService.refundOrder(req.params.orderId, req.user as IJwtPayload);
