...
router.post('/shipping-keys', validateRequest(chitChatShipmentValidation.createShippingKeysZodSchema), chitChatShipmentController.createShippingKeys);
router.get(
     '/',
...
router.post(
     ...
     validateRequest(chitChatShipmentValidation.ChitChatsCreateShipmentBodySchema),
