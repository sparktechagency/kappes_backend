...
const getPaymentByCustomer = catchAsync(async (req: Request, res: Response) => {
     ...
     const { result } = await paymentService.getAllPaymentByUserId(id, role, req.query);
...
const getLast12MonthsEarnings = catchAsync(async (req: Request, res: Response) => {
     ...
     // console.log({ userId });
     const result = await paymentService.getLast12MonthsEarningsService(userId, role);
...
const stripeLoginLink = catchAsync(async (req: Request, res: Response) => {
     const result = await paymentService.stripeLoginLink(req.user as IJwtPayload);
