...
paymentRoutes
     ...
     .get('/', auth(USER_ROLES.USER, USER_ROLES.VENDOR, USER_ROLES.SHOP_ADMIN), paymenController.getPaymentByCustomer)

     .get('/owner', auth(USER_ROLES.VENDOR), paymenController.getAllPaymentByOwnerId)

     .get('/admin', auth(USER_ROLES.SUPER_ADMIN, USER_ROLES.ADMIN), paymenController.getAllPaymentByAdmin)
     .get('/admin/:id', auth(USER_ROLES.SUPER_ADMIN, USER_ROLES.ADMIN), paymenController.getPaymentDetailByAdminById)
