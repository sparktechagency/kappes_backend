...
export interface IVariant {
     ...
     weight?: string; // Optional weight for products like dumbbells, sports equipment, etc.
     volume?: string; // Optional weight for products like dumbbells, sports equipment, etc.
     dimensions?: string; // Single, Queen, King for beds
     capacity?: string; // 1L, 2L
     shape?: string; // 1L, 2L
     flavour?: string; // 1L, 2L
