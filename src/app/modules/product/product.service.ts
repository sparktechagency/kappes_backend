...
//                          const isExistVariantInDB = await Variant.findOne({ _id: new mongoose.Types.ObjectId(variant.variantId), productRef: { $in: [null, new mongoose.Types.ObjectId(id)] } });
...
//                          variantId: existingVariant._id as unknown as ObjectId,
//                          variantQuantity: variant.variantQuantity,
//                          variantPrice: variant.variantPrice,
//                          slug: variant.slug,
//                     };
